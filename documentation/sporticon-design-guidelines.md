...
- However, if center alignment of the path causes the icon to go beyond the boundary or if there an unbalance between the path and fill, please use Inside Stroke. （eg: Ball)
